...
- **MariaDB 10.11 + modo estricto VALIDATED** (F18-02B): instalación limpia 001→018 y batería completa 3/3 sobre un MariaDB 10.11.19 real (sección 3, *Modo SQL*). F18-07 añadió `019` y la referencia de esquema pasó a 001→019 (49 tablas, 496 columnas). F18-19 añadió `020` y `021` (perfiles públicos y Libro de Reclamaciones): referencia 001→021, 56 tablas y 645 columnas, validada en 10.11.19.
...
SHOW TABLES LIKE 'company_profiles';                   -- debe existir (020)
SHOW TABLES LIKE 'complaint_book_entries';             -- debe existir (021)
```
