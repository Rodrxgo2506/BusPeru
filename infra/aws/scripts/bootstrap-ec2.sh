...
#
#   sudo bash bootstrap-ec2.sh --data-volume vol-0123456789abcdef0 [--format-new-volume]
#
...
install -m 0644 "${ORIGEN}/cloudwatch/amazon-cloudwatch-agent.json" /opt/aws/amazon-cloudwatch-agent/etc/amazon-cloudwatch-agent.json
